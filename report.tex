...
\begin{document}
	...
	\subsection{Estimating Moment of Inertia}
	...
	We then plugged in the values to solve for $I$ for the system including the load masses. We were not interested in the system without the load masses for computing $I$, and did not make a prediction for that system.
	...
	To compute the error, we applied the derivative method to equation \ref{eq:i-for-masses}
