...
\begin{document}
	...
	\begin{table}[h]
		\centering
		\caption{Samples of random Monte Carlo data generation. The seed used was $1016$.}
		\begin{tabular}{c|c}
			trial \# & s \\ \hline
			1 & 0.15409 \\
			2 & 0.10925 \\
	...
	\begin{align}
		I_M &= 0.07182 \pm 0.00104\ \mpssq \iUnit \notag \\
	...
	Which is false, so our measured indeed value \textbf{does not} fall within one to two uncertainty intervals from our estimate.
	...
	As this lab was compiled with \LaTeX, the resources and files used for the lab are all stored within the same folder as the submission, which is located in a private Github repository at \newline \texttt{https://github.com/404wolf/phys123-lab5-rke}.
