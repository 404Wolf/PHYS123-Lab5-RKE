...
\begin{document}
	...
	Also, we were provided with the mass of the Roto-Dyne wheel, $M_R$ and the mass loads, $M_L$, of which there were 4.
	...
	To visualize our data, we plotted $v^2$ against displacement for both the system with and without load masses, and did the same for our simulation.
	
	Both plots and datatables can be found in the appendix, section \ref{sect:appendix}.
