...
\begin{document}
	...
	In order to find $I_M$ we first needed to find an equation for it. To begin, using the elementary equation for some slope $y^\prime$ of a linear function plotted on an $x$-$y$ graph, it is well known that
	...
	\paragraph{General equation for $I$}
