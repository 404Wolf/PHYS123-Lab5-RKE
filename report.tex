...
\begin{document}
	...
	\subsection{Computing $I$ for w/Masses}
	...
	\begin{align}
		...
		B &= 0.68204 \pm 0.00168 \frac{\text{m}}{\text{s}^2}
	\end{align}

	So,
	
	\begin{align}
		I &= (.06)(.2)^2 \cdot (\frac{2(9.81)}{0.68204} - 1) \notag \\
	...
	\begin{align}
		I = 0.06663 \pm 0.00017\ \iUnit \label{eq:def-i-measured}
	\end{align}
	...
	\begin{align}
		...
		I &= 0.06663 \pm 0.00017\ \iUnit \tag{\ref{eq:def-i-measured}}
	\end{align}
	...
	\subsection{Computing $I$ for w/o Masses}
	...
	\begin{align}
		B = 1.26494 \pm 0.00889 \frac{\text{m}}{\text{s}^2}
	\end{align}
	...
	\subsection{Mass Load $I$}
	
	Knowing the experimental moment of inertia for the system with the mass loads and the system without the mass loads, we can compute $I_L$, the moment of inertia of the system only with the mass loads, by subtracting the moment of inertia of the system with the mass loads by the system without the mass loads. For this section, we will rename $I$ for the masses system $I_1$ and $I$ for the no masses system $I_2$
	...
	We will base the uncertainty of this measurement on the literal, complete equation, subbing in $I$s for equation \ref{eq:i-for-masses}. We will also denote $B$ for the system with masses here as $B_1$ and $B$ for the system without masses as $B_2$.
	
	\begin{align}
		Mr^2 \cdot (\frac{2g}{B_1} - 1) - Mr^2 \cdot (\frac{2g}{B_2} - 1)
	\end{align}
	
	\begin{align}
		\delta_{M_L} = 0.002\ \text{kg} \tag{\ref{eq:def-ml}}
	\end{align}
